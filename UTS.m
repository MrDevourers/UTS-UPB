...
% Last Modified by GUIDE v2.5 07-May-2021 18:01:58
...
if ~isequal(filename,0)
    ...
    if m == 3
       ...
       imshow(Img)
       handles.Img = Img;
       title('\color{White}RGB Image');
       ax3 = title('\color{White}Default Image');
       guidata(hObject, handles)
    else
    msgbox('The Imagery chosen must be RGB');
    end
else
    return
end
...
title('\color{White}Green Imagery')
...
cla('reset')
imshow(Blue_Channel)
title('\color{White}Blue Imagery')
